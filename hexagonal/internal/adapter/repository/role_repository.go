...
func (rr *RoleRepository) GetOne(ctx context.Context, id int) (*domain.Role, error) {
	role := domain.Role{}
...
func (rr *RoleRepository) GetMany(ctx context.Context) ([]*domain.Role, error) {
...
func (rr *RoleRepository) GetManyById(ctx context.Context, ids []int) ([]*domain.Role, error) {
	var roles []*domain.Role
	if len(ids) == 0 {
		return roles, nil
	}
...
func (rr *RoleRepository) Update(ctx context.Context, role *domain.Role) (*domain.Role, error) {
